...
export default function LeaderboardPage() {
  ...
  return (
    <div className={cn("min-h-screen bg-white flex flex-col")}> 
      <div className={cn("flex-1 flex flex-col", account ? "pb-32" : "pb-20")}> {/* Use flex-col for proper scrolling */}
        <div className="p-6 pb-0"> {/* Header section - no bottom padding */}
              ...
              <div className={cn("flex justify-center items-end gap-3")}> 
                ...
                {topThree[1] ? (
                  <div className={cn("flex flex-col items-center")}> 
                    <div className={cn("w-12 h-12 rounded-full border-2 border-gray-400 mb-2 overflow-hidden")}>
                      <img 
                ...
                {topThree[0] ? (
                  <div className={cn("flex flex-col items-center")}> 
                    <div className={cn("w-16 h-16 rounded-full border-2 border-yellow-500 mb-2 overflow-hidden")}>
                      <img 
                ...
                {topThree[2] ? (
                  <div className={cn("flex flex-col items-center")}> 
                    <div className={cn("w-12 h-12 rounded-full border-2 border-orange-400 mb-2 overflow-hidden")}>
                      <img 
        ...
        <div className="flex-1 overflow-y-auto px-6"> {/* This makes the content scrollable */}
          <div className="space-y-3 max-w-md mx-auto pb-6"> {/* Added bottom padding for better scroll experience */}
            {remainingUsers.map((user, index) => (
              <div key={user.userId} className={cn("flex items-center gap-3 p-3 bg-gray-50 rounded-lg")}> 
                ...
                {/* Username */}
                <div className="flex-1 min-w-0"> {/* min-w-0 prevents flex item from growing too much */}
        ...
        <div className={cn("fixed bottom-16 left-1/2 -translate-x-1/2 w-full max-w-[390px] bg-white border-t border-gray-200 px-4 py-3 z-40")}>
          <div className={cn("bg-gray-100 border border-gray-300 p-3 flex items-center justify-between")}>
            <div className="flex items-center gap-3">
              <div className={cn("w-8 h-8 rounded-full overflow-hidden flex-shrink-0")}>
                <img 
              ...
              <div className="min-w-0"> {/* Prevent overflow */}
                <div className="font-medium text-sm truncate">{currentUserData.username}</div>
