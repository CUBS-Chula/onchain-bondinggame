          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <button
                  onClick={createRoom}
                  className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 py-4 rounded-xl font-semibold hover:from-green-600 hover:to-emerald-600 transform hover:scale-105 transition-all duration-200 shadow-lg text-center"
                >
